// yoinked from aws-cdk-lib
// https://github.com/aws/aws-cdk/blob/main/packages/aws-cdk/lib/util/yaml-cfn.ts
// needs yaml v1
  ...
  return {
    ...
    resolve: (_doc: yaml.Document, cstNode: yaml_cst.CST.Node) => {
      ...
      ret[addFnPrefix ? `Fn::${intrinsicName}` : intrinsicName] =
        ...
        parseYamlStrWithCfnTags(
          cstNode.toString().substring(intrinsicName.length + 1),
        );
      return ret;
    },
  };
